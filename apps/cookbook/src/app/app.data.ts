...
export const SIGNAL_EXAMPLES: {
  ...
  },
  {
    ...
    api: 'submit()',
    level: 'Core',
    tags: ['submit()', 'FormRoot', 'server errors'],
  ...
  {
    title: $localize`:@@recipe.11.title:Dynamic Forms`,
    category: 'Dynamic',
    app: $localize`:@@app.dynamicForm:Dynamic Form`,
    description: $localize`:@@recipe.11.desc:Build the model, schema, and fields at runtime from a JSON config.`,
    api: 'schema()',
    level: 'Pro',
    tags: ['json', 'runtime', 'dynamic'],
    link: '11-dynamic-forms/',
    tone: 'blue',
  },
];
